...
urlpatterns = [
    ...
    path('start_analysis_newpondscape/', start_analysis_newpondscape, name='start_analysis_newpondscape'),
    path('start_analysis_samepondscape/', start_analysis_samepondscape, name='start_analysis_samepondscape'),
